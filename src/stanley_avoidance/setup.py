...
# Note: The following lines were previously present but have been modified:
# The option names like 'script-dir' and 'install-scripts' have been changed to 'script_dir' and 'install_scripts'.
